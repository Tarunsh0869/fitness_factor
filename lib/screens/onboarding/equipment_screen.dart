...
class EquipmentScreen extends StatelessWidget {
  ...
  static const _items = [
    ...
    (EquipmentType.kettlebells, 'Kettlebells', Icons.sports_gymnastics_outlined),
    (EquipmentType.machines, 'Machines', Icons.precision_manufacturing_outlined),
    (EquipmentType.none, 'None of the above', Icons.do_not_disturb_alt_outlined),
  ];
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return OptionCard(
                ...
                leading: Icon(item.$3, color: selected ? const Color(0xFF1689F7) : const Color(0xFF80858F)),
              );
            },
          ),
        ),
