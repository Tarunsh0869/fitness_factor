...
class _AttendanceFormScreenState extends State<AttendanceFormScreen> {
  ...
  void initState() {
    ...
    if (_isEdit) {
      _workoutType = widget.existing!.workoutType?.isNotEmpty == true
          ? widget.existing!.workoutType! : 'General';
  ...
  Future<void> _pickDateTime({required bool isCheckIn}) async {
    ...
    setState(() { if (isCheckIn) { _checkedIn = picked; } else { _checkedOut = picked; } });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(_isEdit ? 'Edit Attendance' : 'Log Attendance',
            ...
            Wrap(
              ...
              children: _workoutTypes.map((w) {
                ...
                return GestureDetector(
                  onTap: () => setState(() => _workoutType = w['label'] as String),
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(w['icon'] as IconData,
                            color: sel ? _blue : _muted, size: 16),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text(_formatDuration(_checkedOut!.difference(_checkedIn)),
              ...
              child: DecoratedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _loading
                      ...
                      : Text(_isEdit ? 'Save Changes' : 'Log Attendance',
