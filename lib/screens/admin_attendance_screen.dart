...
class _AdminAttendanceScreenState extends State<AdminAttendanceScreen> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Total gym time: ${_fmtDur(totalMin)}',
  ...
  Widget _buildHourlyChart() {
    ...
    final maxVal = hours.map((h) => hourCounts[h])
        .reduce((a, b) => a > b ? a : b).clamp(1, 9999);
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Hourly Traffic (6am \u2013 10pm)',
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: hours.map((h) {
                ...
                final isPeak = val == hourCounts.reduce((a, b) => a > b ? a : b)
                    && val > 0;
                return Expanded(
                  child: Padding(
    ...
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(
        builder: (_) => AdminMemberDetailScreen(
          memberId: r['memberId'] as String, gymId: widget.gymId,
        ),
      )),
      child: Container(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text((r['source'] as String).toUpperCase(),
